...
class UNBC_Organization_Manager_Dashboard {
    ...
    public function add_manager_menu() {
        ...
        // Add main menu for organization manager
        add_menu_page(
            'My Organization',
            'My Organization',
            'edit_organizations',
                ...
                <div id="poststuff">
                    <div id="post-body" class="metabox-holder columns-2">
                        <div id="post-body-content">
                                ...
                                <div class="inside">
                                    <table class="form-table">
                                        <tr>
                                            ...
                                            <td>
                                                <input type="email" name="org_email" id="org_email" value="<?php echo esc_attr($meta_fields['org_email']); ?>" class="regular-text">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th><label for="org_phone">Phone</label></th>
                                            <td>
                                                <input type="tel" name="org_phone" id="org_phone" value="<?php echo esc_attr($meta_fields['org_phone']); ?>" class="regular-text">
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th><label for="org_location">Location/Address</label></th>
                                            <td>
                                                <textarea name="org_location" id="org_location" rows="3" class="large-text"><?php echo esc_textarea($meta_fields['org_location']); ?></textarea>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <!-- Social Media -->
                            <div class="postbox">
                                <h2 class="hndle"><span>Social Media</span></h2>
                                <div class="inside">
                                    <table class="form-table">
                                        <tr>
                                            <th><label for="org_facebook">Facebook URL</label></th>
                                            <td>
                                                <input type="url" name="org_facebook" id="org_facebook" value="<?php echo esc_attr($meta_fields['org_facebook']); ?>" class="large-text">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th><label for="org_twitter">Twitter/X URL</label></th>
                                            <td>
                                                <input type="url" name="org_twitter" id="org_twitter" value="<?php echo esc_attr($meta_fields['org_twitter']); ?>" class="large-text">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th><label for="org_instagram">Instagram URL</label></th>
                                            <td>
                                                <input type="url" name="org_instagram" id="org_instagram" value="<?php echo esc_attr($meta_fields['org_instagram']); ?>" class="large-text">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th><label for="org_linkedin">LinkedIn URL</label></th>
                                            <td>
                                                <input type="url" name="org_linkedin" id="org_linkedin" value="<?php echo esc_attr($meta_fields['org_linkedin']); ?>" class="large-text">
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <!-- Meeting Information -->
                            <div class="postbox">
                                <h2 class="hndle"><span>Meeting Information</span></h2>
                                <div class="inside">
                                    <table class="form-table">
                                        <tr>
                                            <th><label for="org_meeting_time">Regular Meeting Time</label></th>
                                            <td>
                                                <input type="text" name="org_meeting_time" id="org_meeting_time" value="<?php echo esc_attr($meta_fields['org_meeting_time']); ?>" class="regular-text">
                                                <p class="description">e.g., "Every Tuesday at 6:00 PM"</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th><label for="org_meeting_location">Meeting Location</label></th>
                                            <td>
                                                <input type="text" name="org_meeting_location" id="org_meeting_location" value="<?php echo esc_attr($meta_fields['org_meeting_location']); ?>" class="large-text">
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <!-- Leadership -->
                            <div class="postbox">
                                <h2 class="hndle"><span>Leadership</span></h2>
                                <div class="inside">
                                    <table class="form-table">
                                        <tr>
                                            <th><label for="org_president">President/Chair</label></th>
                                            <td>
                                                <input type="text" name="org_president" id="org_president" value="<?php echo esc_attr($meta_fields['org_president']); ?>" class="regular-text">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th><label for="org_vice_president">Vice President/Vice Chair</label></th>
                                            <td>
                                                <input type="text" name="org_vice_president" id="org_vice_president" value="<?php echo esc_attr($meta_fields['org_vice_president']); ?>" class="regular-text">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th><label for="org_secretary">Secretary</label></th>
                                            <td>
                                                <input type="text" name="org_secretary" id="org_secretary" value="<?php echo esc_attr($meta_fields['org_secretary']); ?>" class="regular-text">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th><label for="org_treasurer">Treasurer</label></th>
                                            <td>
                                                <input type="text" name="org_treasurer" id="org_treasurer" value="<?php echo esc_attr($meta_fields['org_treasurer']); ?>" class="regular-text">
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        <div id="postbox-container-1" class="postbox-container">
                            ...
                            <!-- Organization Status -->
                            <div class="postbox">
                                <h2 class="hndle"><span>Organization Status</span></h2>
                                <div class="inside">
                                    <p><strong>Status:</strong> <?php echo ucfirst($organization->post_status); ?></p>
    ...
    public function handle_organization_update() {
        ...
        // Temporarily remove any block-related filters that might cause issues
        ...
        // Update meta fields
        $meta_fields = array(
            'org_email', 'org_phone', 'org_website', 'org_location',
            'org_facebook', 'org_twitter', 'org_instagram', 'org_linkedin',
            'org_meeting_time', 'org_meeting_location',
            'org_president', 'org_vice_president', 'org_secretary', 'org_treasurer'
        );
